            ...
            <form action="{{ route('panel.video.update', $video->uuid) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name"
                        class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $video->name) }}">
                ...
                {{-- <div class="mb-3">
                    ...
                    <input type="file" name="thumbnail" id="thumbnail" accept="video/*"
                        class="form-control  @error('thumbnail') is-invalid @enderror">

                    <div>
                        <img src="{{ asset('storage/' . $video->thumbnail) }}" alt="" class="img-fluid mt-3" width="15%">
                    </div>
