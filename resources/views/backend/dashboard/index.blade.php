                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="text-gray-400 mb-0" style="font-size: 14px;">Tota Transactions</h2>
                                <h3 class="fw-extrabold mb-2">{{ $totalTransactions }}</h3>
                            </div>
                            {{-- <small class="d-flex align-items-center text-gray-500">
                                {{ \Carbon\Carbon::parse('first day of -2 month')->format('M 1') }} - {{ \Carbon\Carbon::parse('first day of +1 month')->format('M 1') }}
                            </small> --}}
                        </div>
                    </div>
                </div>
